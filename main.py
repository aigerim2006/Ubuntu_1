...
# дз №4 задание 2 подсветка последнего имени
...
def main(page: ft.Page):
    ...
    def on_button_click(_):
        ...
        if name:
            ...
            greeting_text.spans = [ft.TextSpan('Hello '), ft.TextSpan(name, ft.TextStyle(color=ft.Colors.ORANGE))]
    ...
    page.add(greeting_text, ft.Row([name_input, send_button, clear_button]), history_text)
